...
# print(sampleStr.find("the"))      # RETURNS 31
# print(sampleStr.rfind("The"))     # RETURNS 0
# print("The" in sampleStr)         # RETURNS True

# TODO: using replace
# newStr = sampleStr.replace("lazy", "tired")
# print(newStr)                     # RETURNS The quick brown fox jumps over the tired dog
